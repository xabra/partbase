...
partBaseApp.config(['$routeProvider', '$locationProvider',
   function($routeProvider, $locationProvider) {
      ...
      when('/docs', {
         templateUrl: 'partials/doc-list.tmpl.html',
         controller: 'docListCtrl'
      }).
      when('/docs/new', {
         templateUrl: 'partials/doc-new.tmpl.html',
      ...
      when('/docs/detail/:id', {
         templateUrl: 'partials/doc-detail.tmpl.html',
      ...
      when('/register', {
         templateUrl: 'partials/register.tmpl.html',
         controller: 'registerCtrl'
      }).
      when('/users/list', {
         templateUrl: 'partials/users-list.tmpl.html',
         controller: 'usersListCtrl'
      }).
      when('/organizations/list', {
         templateUrl: 'partials/organizations-list.tmpl.html',
         controller: 'organizationsListCtrl'
      }).
      when('/organizations/create', {
         templateUrl: 'partials/organizations-create.tmpl.html',
