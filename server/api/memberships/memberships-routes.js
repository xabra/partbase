...
router.get('/api/memberships/count', memberships.count());          // Get a list of memberships
...
router.post('/api/memberships/:itemId', memberships.updateById()); // Update membership given its Id
